...
public class MqttConnectRequestHandler {
    ...
    public static MqttPacket buildResponsePacket(Client client, MqttConnectPacket mqttPacket) throws MqttPacketException {
        switch (mqttPacket.getVersion()) {
            case V3_1_1:
                return buildV311(client, mqttPacket);
        }
        throw new MqttPacketException();
    }

    private static MqttPacket buildV311(Client client, MqttConnectPacket mqttPacket) {
